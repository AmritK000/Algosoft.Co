...
!(function (e, t) {
                ...
                return (
                    H ||
                        ...
                        B &&
                            ...
                            I && L && ((V = L.core._getVelocityProp), (j = L.core._inputObserver), (ScrollSmoother.refresh = L.refresh), (H = 1)))),
                    H
                );
            }),
    ...
    function ScrollSmoother(e) {
        ...
        function Fa(r, e, t, n) {
            function tb() {
                (e = s()), (t = f()), (o = parseFloat(e) || 1), (c = (a = "auto" === e) ? 0 : 0.5), l && l.kill(), (l = t && B.to(r, { ease: O, overwrite: !1, y: "+=0", duration: t })), i && ((i.ratio = o), (i.autoSpeed = a));
            }
            function ub() {
                ...
                if (a) {
                    ...
                    var t = (function _autoDistance(e, t) {
                        var r,
                            ...
                            u = -c * t;
                        return 0 < c && ((u += -(n = 0.5 == (r = s.height / (F.innerHeight + s.height)) ? 2 * s.height : 2 * Math.min(s.height, (-c * r) / (2 * r - 1))) / 2), (c += n)), { change: c, offset: u };
                                    ...
                                    if (i) {
                                        for (r = -k, n = e.end; i--; ) {
                                            if ((t = g[i]).trig.isActive || (r >= t.start && r <= t.end))
                                                return void (l && ((t.trig.progress += t.trig.direction < 0 ? 0.001 : -0.001), t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(d.y), -C, !0), P && l.progress(1)));
        ...
        var n,
            ...
            T = e.normalizeScroll,
            x = L.getScrollFunc(F),
            E = 1 === L.isTouch ? (!0 === g ? 0.8 : parseFloat(g) || 0) : 0 === b || !1 === b ? 0 : parseFloat(b) || 0.8,
            k = 0,
            C = 0,
            P = 1,
            _ = V(0),
        ...
        L.addEventListener("refresh", Ba),
            ...
            (this.content = function (e) {
                if (arguments.length) {
                    ...
                    return t !== n && ((c = (n = t).getAttribute("style") || ""), B.set(n, { overflow: "visible", width: "100%", boxSizing: "border-box" })), this;
                }
                return n;
            }),
                ...
                return arguments.length
                    ? (!!u !== e &&
                          (e
                              ...
                              : (u.nested.kill(), u.kill(), (u = 0), r && r.enable(), (i.progress = (-k - i.start) / (i.end - i.start)), va(i))),
                      this)
                    : !!u;
            }),
            (this.kill = function () {
                ...
                var r = L.defaults({});
                r && r.scroller === m && L.defaults({ scroller: F }), o.normalizer && L.normalizeScroll(!1), clearInterval(a), (N = null), F.removeEventListener("focusin", za);
            }),
